package frc.robot.auton.paths.RedPaths;
...
public class RollerHighRed {
  ...
  List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup("RollerHighRed", new PathConstraints(2, 2));

  public RollerHighRed(){
