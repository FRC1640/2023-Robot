...
public class SuperDuperUltraPlacer {
  ...
  List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup("SuperDuperUltraPlacer", new PathConstraints(2, 2));

  public SuperDuperUltraPlacer(){
